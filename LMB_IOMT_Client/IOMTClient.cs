...
using LMB_IOMT_Client;
using LMB_IOMT_Common;
...
namespace TCPIPClient
{
    public partial class frmClient : Form
    {
        ...
        private PacketBase HostServerRawPackets = null;
        ...
        private void frmClient_Load(object sender, EventArgs e)
        {
            ...
            textBoxText.Text = "Bagmatic sample response ...";
        }
        ...
        private void buttonSendDataToServer_Click(object sender, EventArgs e)
        {
            ...
            Int32 num1 = 0;
            Int32.TryParse(textBoxText.Text, out num1);
            xdata.Data16 = num1;
            Int32 num2 = 0;
            Int32.TryParse(textBoxText.Text, out num2);
            xdata.Data17 = num2;
        ...
        private void InitializeServerConnection()
        {
            try
            {
                ...
                if (HostServerRawPackets == null)
                    HostServerRawPackets = new PacketBase(0);
                else
                {
        ...
        private void HostCommunicationsHasQuit(bool FromHost)
        {
            ...
            if (client != null)
            {
                ...
                {
                    labelStatusInfo.Text = "Comm closed!!";
                }
